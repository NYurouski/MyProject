...
public class SCommandEditOrder extends SCommand
{
	private static final Logger log = Logger.getLogger(SCommandEditOrder.class);
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) 
	{
		...
		try 
		{	
			response.sendRedirect("SiteCont?operation=order&name="+name+
					"&surname="+surname+"&carid="+carid);
		} 
		catch (IOException e) 
		{
			log.error("Something failed", e);
